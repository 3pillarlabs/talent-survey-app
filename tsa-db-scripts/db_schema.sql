CREATE DATABASE  IF NOT EXISTS `survey_database` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `survey_database`;
...
--
-- Table structure for table `survey_launch`
--

DROP TABLE IF EXISTS `survey_launch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `survey_launch` (
...
-- Dump completed on 2018-04-18 14:53:03
